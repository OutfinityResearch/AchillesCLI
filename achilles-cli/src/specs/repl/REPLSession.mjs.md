...
Manages the interactive REPL session for achilles-cli, coordinating input handling, command processing, and result display.
...
Content displayed:
1. Header bar with "Achilles CLI" title
