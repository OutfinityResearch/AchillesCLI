...
Entry point for the achilles-cli CLI application, providing both library exports and command-line execution.

## Overview

This module serves as the main entry point for achilles-cli. It can be imported as a library to access core components, or executed directly as a CLI tool for managing skill definition files.
...
- Environment variable ACHILLES_CLI_UI can set default style
...
6. Initialize LLMAgent with name "achilles-cli-agent"
