...
Centralized constants for achilles-cli providing a single source of truth.

## Overview

This module exports all constant values used throughout achilles-cli, including built-in skill names, timeouts, configuration values, and error codes.
