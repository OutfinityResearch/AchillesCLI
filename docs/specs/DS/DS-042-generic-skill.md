...
The module architecture passes prompt to llmAgent with context (workspaceRoot, specsRoot) and returns raw response. It minimal logic; used when no specific skill applies.
